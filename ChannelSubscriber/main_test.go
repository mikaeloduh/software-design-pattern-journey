...
func TestChannelSubscriber(t *testing.T) {
	...
	waterBall := entity.NewSubscriber("水球")
	fireBall := entity.NewSubscriber("火球")

	unsubscribe := func(c *entity.Channel, v *entity.Video, this *entity.Subscriber) {
		if v.Length <= 60 {
			c.Unsubscribe(this)
		}
	}
	likeVideo := func(_ *entity.Channel, v *entity.Video, this *entity.Subscriber) {
		if v.Length >= 180 {
			v.Like(this)
		}
	}
...
func FakeNewChannel(name string, w io.Writer) *entity.Channel {
	return &entity.Channel{Name: name, Writer: w}
}
