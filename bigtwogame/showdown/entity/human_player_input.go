...
type HumanPlayerInput struct{}

func (i HumanPlayerInput) InputString() string {
...
func (i HumanPlayerInput) InputNum(min int, max int) int {
	fmt.Print("(", min, " ~ ", max, "): ")
...
func (i HumanPlayerInput) InputBool() bool {
	fmt.Print("(y/n): ")
